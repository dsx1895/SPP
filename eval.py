...
parser.add_argument(
    "--test_dir", type=str, default="data/wav8k/min/test",  help="Test directory including the csv files"
)
parser.add_argument(
    "--task",
    type=str,
...
def main(conf):
    ...
    model = e2e_noisy_sep_signal_verse_DPRNNTasNet.from_pretrained(model_path)
