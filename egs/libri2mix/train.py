...
def main(conf):
    ...
    model = e2e_noisy_sep_signal_verse_DPRNNTasNet(
    ...
    checkpoint = ModelCheckpoint(
        dirpath=checkpoint_dir, monitor="val_loss", mode="min", save_top_k=5, verbose=True
    )
...
if __name__ == "__main__":
    ...
    with open("local/conf_e2e_noisy_sep.yml") as f:
